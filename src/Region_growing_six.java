...
public class Region_growing_six {
    ...
    public static void main(String[] args) throws IOException {
        ...
        r = Region_growing_six.getRaster_input();
...
//            rand_value = 100*600;
            ...
            IntStream.rangeClosed(1,w*2).parallel().forEach(Region_growing_six::reseach_RG_for_stream);
